    ...
    <div>
        <section className="hero-section">
            <div className="container">
                <h1 className="hero-title">DO IT <span className="blue">RIGHT</span></h1>
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <div className="hero-content">
                                ...
                                <Link to="/products" className="btn btn-dark btn-lg"><i className="fas fa-shopping-cart"></i> SHOP NOW</Link>
                            </div>
                        </div>
    ...
    <section className="new-drops">
        <div className="container">
            <div className="section-header">
                <h2 className="section-title">DON'T MISS OUT<br/>NEW DROPS</h2>
                    ...
                    {featuredProducts.map(product => (
                        <div key={product.id} className="col-md-3 col-sm-6">
                            <div className="product-card">
                                ...
                                <h5 className="product-title">ADIDAS 4DFWD X PARLEY RUNNING SHOES</h5>
            ...
            <div className="row">
                <div className="col-md-6">
                    <div className="category-card">
                        ...
                        <h3 className="category-title">LIFESTYLE<br/>SHOES</h3>
                ...
                <div className="col-md-6">
                    <div className="category-card">
                        ...
                        <h3 className="category-title">BASKETBALL<br/>SHOES</h3>
                        <div className="category-arrow">
                            <i className="fas fa-arrow-right"></i>
                        </div>
                    </div>
                ...
                {categories.map(category => (
                    <div key={category.id} className="col-lg-2 col-md-4 col-6">
                        <Link to={`/products?category_id=${category.id}`}
                            ...
                            <img src="https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=400" alt="Basketball Shoes" style={{top: '30%'}}/>
                ...
                <div className="col-md-4">
                    <div className="review-card">
                        <div className="review-header">
                            ...
                            <div>
                                <h6 className="mb-0"><strong>Good Quality</strong></h6>
                                <small className="text-muted">I highly recommend shopping from kicks</small>
                            </div>
                        </div>
                        <div className="stars">
                        ...
                        <img src="https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=400" alt="Review" className="review-image"/>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="review-card">
                        ...
                        <img src="https://images.unsplash.com/photo-1612902456551-333ac5afa26e?w=400" alt="Review" className="review-image"/>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="review-card">
                        ...
                        <img src="https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=400" alt="Review" className="review-image"/>
                    </div>
                </div>
            </div>
        </div>
