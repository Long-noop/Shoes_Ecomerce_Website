...
const AdminDashboard = () => {
    ...
    const loadDashboardData = async () => {
        ...
        const [ordersRes, productsRes, usersRes] = await Promise.all([
            ...
            userService.getUsers({ per_page: 1 }),
        ]);
  ...
  return (
    // <div className="page-body admin-dashborad">
    //     <div className="container-fluid">
    //         <div className="page-header-custom">
    //             <h2 className="page-title">Dashboard</h2>
    //             <div className="breadcrumb-custom">Home {'>'} Dashboard</div>
    //         </div>        
    ...
    //                                 <i className="ti ti-eye" style={{ fontSize: "24px" }}></i>
    //                             </div>
    //                         </Link>
    //                     </div>
    //                 </div>
    ...
    //                     <Link to="/admin/order-list" className="btn btn-dark btn-lg">
    //                         View All Orders
    //                     </Link>
    //                 </div>
    //             </div>
    ...
    //                             </td>
    //                             <td>
    //                             <span className={`status-badge ${getStatusBadge(order.status)}`} style={{color:"white"}}>
    //                                 ● {order.status}
    //                             </span>
    //                             </td>
    //                             <td>
    ...
    //                                 >
    //                                     <i className="ti ti-eye" style={{ fontSize: "16px" }}></i>
    //                                 </Link>
    //                             </td>
    //                         </tr>
    //                         ))}
        ...
        <div className="page-header d-print-none" aria-label="Page header">
          <div className="container-fluid">
            <div className="row g-2 align-items-center">
              <div className="col">
                <div className="page-pretitle">Hello,</div>
                <h2 className="page-title">How are you today?</h2>
              </div>
          ...
          <div className="container-fluid">
            <div className="row row-deck row-cards">
                      ...
                      <div className="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div className="divide-y">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/002f.jpg)' }}> </span>
                              </div>
                              <div className="col">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/003f.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate"><strong>Christabel Charlwood</strong> created a new project for <strong>Wikibox</strong>.</div>
                                <div className="text-secondary">4 days ago</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/063m.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/006m.jpg)' }}> </span>
                              </div>
                              <div className="col">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/004f.jpg)' }}> </span>
                              </div>
                              <div className="col">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/007m.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate"><strong>Perren Keemar</strong> and 3 others followed you.</div>
                                <div className="text-secondary">now</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              ...
                              <div className="col">
                                <div className="text-truncate"><strong>Sunny Airey</strong> upload 3 new photos to category <strong>Inspirations</strong>.</div>
                                <div className="text-secondary">2 days ago</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/009m.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate"><strong>Geoffry Flaunders</strong> made a <strong>$10</strong> donation.</div>
                                <div className="text-secondary">2 days ago</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/010m.jpg)' }}> </span>
                              </div>
                              <div className="col">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/005f.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate"><strong>Dyann Escala</strong> hosted the event <strong>Tabler UI Birthday</strong>.</div>
                                <div className="text-secondary">4 days ago</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              <div className="col-auto">
                                <span className="avatar avatar-1" style={{ backgroundImage: 'url(./static/avatars/006f.jpg)' }}> </span>
                              </div>
                              <div className="col">
                                <div className="text-truncate"><strong>Avivah Mugleston</strong> mentioned you on <strong>Best of 2020</strong>.</div>
                                <div className="text-secondary">now</div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <div className="row">
                              ...
                              <div className="col">
                                <div className="text-truncate"><strong>Arlie Armstead</strong> sent a Review Request to <strong>Amanda Blake</strong>.</div>
                                <div className="text-secondary">2 days ago</div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col">
                          ...
                          <div className="text-secondary">
                            <svg
                              ...
                              stroke-linecap="round"
                              stroke-linejoin="round"
                              className="icon icon-inline text-green icon-3"
                            >
                              <path d="M3 17l6 -6l4 4l8 -8" />
                              <path d="M14 7l7 0l0 7" />
                            </svg>
                  ...
                  <div className="card-table table-responsive">
                    <table className="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="w-1">
                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/052f.jpg)' }}> </span>
                          </td>
                          <td className="td-truncate">
                        ...
                        <tr>
                          <td className="w-1">
                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/002m.jpg)' }}> </span>
                          </td>
                          <td className="td-truncate">
                            <div className="text-truncate">justify-content:between ⇒ justify-content:space-between (#29734)</div>
                          </td>
                        ...
                        <tr>
                          <td className="w-1">
                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/000f.jpg)' }}> </span>
                          </td>
                          <td className="td-truncate">
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 480 373" className="position-absolute top-0 right-0 bottom-0 left-0 w-100 h-100">
                    <path
                    ...
                    />
                    <path
                      fill="color-mix(in srgb, black 20%, var(--tblr-primary))"
                        ...
                        <div className="mt-4">
                          <button className="btn w-100 pe-none" type="button">
                            <svg
                              ...
                              viewBox="0 0 24 24"
                              fill="currentColor"
                              className="icon text-pink icon-3"
                            >
                              <path
                    ...
                    <table className="table table-selectable card-table table-vcenter">
                      <tr>
                        <td className="w-1 pe-0">
                          <input type="checkbox" className="form-check-input m-0 align-middle table-selectable-check" aria-label="Select task" checked />
                        </td>
                        <td className="w-100">
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/001f.jpg)' }}> </span>
                        </td>
                      </tr>
                    </table>
                  </div>
