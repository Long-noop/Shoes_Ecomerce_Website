    ...
    <div className="page-body admin-contact">
        <div className="container-fluid">
            ...
            <div className="stats-row">
                <button className='btn-link p-0 text-decoration-none' onClick={() => setFilters({ status: '', page: 1, per_page: 20 })} style={{background:'none'}}>
                ...
                <button className='btn-link p-0 text-decoration-none' onClick={() => setFilters({ status: 'unread', page: 1, per_page: 20 })} style={{background:'none'}}>
                <div className="stat-card">
                    <div className="stat-header">
                ...
                <button className='btn-link p-0 text-decoration-none' onClick={() => setFilters({ status: 'responded', page: 1, per_page: 20 })} style={{background:'none'}}>
                <div className="stat-card">
                    <div className="stat-header">
                ...
                <button className='btn-link p-0 text-decoration-none' onClick={() => setFilters({ status: 'pending', page: 1, per_page: 20 })} style={{background:'none'}}>
                <div className="stat-card">
                    <div className="stat-header">
                    ...
                    <table className="contacts-table">
                        ...
                        <tbody>
                            ...
                            <tr key={contact.id}>
                                ...
                                <td><div className="contact-message">{contact.message}</div></td>
                                <td>
                                ...
                                <td><span className={`status-badge status-${getStatusBadge(contact.status)}`}>{contact.status}</span></td>
                                <td>
                                    <div className="action-btns">
                                        <button className="btn-icon view" onClick={() => handleViewContact(contact.id)}>
                                            <i className="ti ti-eye"></i>
                                        </button>
                                        <button className="btn-icon delete" onClick={() => handleDelete(contact.id)}>
                                            <i className="ti ti-trash"></i>
                                        </button>
                                    </div>
                                </td>
          ...
          <div className="modal modal-blur fade show" style={{ display: 'block' }} tabIndex="-1">
                ...
                <div className="modal-content">
                    ...
                    <div className="mb-3">
                        ...
                        <div className="border p-3 rounded">{selectedContact.message}</div>
                    </div>
                    <div className="mb-3">
                        <label className="form-label">Date</label>
                        <div>{new Date(selectedContact.created_at).toLocaleString()}</div>
                    </div>
                    <div className="mb-3">
