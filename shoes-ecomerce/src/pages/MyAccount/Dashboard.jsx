  ...
  return (
    <section id="dashboard" className="content-section active">
      ...
      <div className="alert alert-info">
        <strong>🎉 Member Benefits:</strong> You're a KICKS Plus member! Enjoy
        free shipping on all orders and exclusive early access to new drops.
      </div>
          ...
          <tbody>
            {recentOrders.map((order) => (
              <tr key={order.id}>
                ...
                <td>
                  <span
                    className={`order-status bg-${getStatusColor(
                      order.status
                    )}`}
                    style={{ color: "white" }}
                  >
                ...
                <td>
                  <Link
                    to={`/my-account/orders/details/${order.id}`}
