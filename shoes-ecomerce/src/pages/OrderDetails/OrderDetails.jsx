      ...
      <div className="container-fluid m-auto">
        ...
        <div className="info-cards-row">
          <div className="info-card">
            ...
            {user && (
              <div className="info-details">
                ...
                <div>
                  <span className="info-label">Phone:</span> +900 231 1212
                </div>
              </div>
            )}
          ...
          <div className="info-card">
            ...
            <div className="info-details">
              <div>
                <span className="info-label">Shipping:</span> Next express
              </div>
              <div>
                <span className="info-label">Payment Method:</span> Paypal
              </div>
              <div>
          ...
          <div className="info-card">
            ...
            <div className="info-details">
              <div>
                <span className="info-label">Address:</span> Santa Ana, Illinois
              </div>
        ...
        <div className="payment-note-row">
          <div className="payment-card">
            ...
            <div className="info-details">
              <div>
                <span className="info-label">Business name:</span> Jane Cooper
              </div>
              <div>
                <span className="info-label">Phone:</span> +900 231 1212
              </div>
