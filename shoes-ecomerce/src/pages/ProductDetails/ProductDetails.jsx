          ...
          <div className="product-grid">
            <div className="product-images">
              <div className="main-image">
                <button className="image-nav prev">
                  <i className="fas fa-chevron-left"></i>
                </button>
                <img src={product.image_url} alt="Product" id="mainImage" />
              ...
              <div className="thumbnail-grid">
                ...
                <div
                  className="thumbnail"
                  data-image="https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=600"
                >
                ...
                <div className="option-group">
                  ...
                  <div className="color-options">
                    <div
                      ...
                      style={{ backgroundColor: "#2d5016", dataColor: "green" }}
                    ></div>
                    <div
                      className="color-option"
                      style={{ backgroundColor: "#4a4a4a", dataColor: "gray" }}
                    ></div>
                  </div>
                </div>
